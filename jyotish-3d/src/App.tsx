...
import type { ApiResponse, ChartData, Planet, TransitPlanet, SavedChart } from "./store/chartStore";
import {
  PLANET_COLORS,
  PLANET_EMISSIVE,
  PLANET_SIZES,
...
const STAGE_LEXICON: Record<string, { frame: string; key: string; trap: string }> = {
  ...
  nakshatras: {
    ...
    trap: "El pāda es pequeño, pero cambia el tono de la expresión.",
  },
  dashas: {
    frame: "¿Cuándo?",
...
function arcPoints(radius: number, start: number, end: number, y = 0.08, steps = 10): [number, number, number][] {
